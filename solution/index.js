...
function fill_colors () {
  ...
  let free_spots = [];
  // Skapa ett element i arrayen free_spots för varje cell i gridden.
...
function get_one_color (free_spots) {
  ...
  fetch(request)
    ...
    .then(color => {
      ...
      // Splice returnerar en array med elementen som har tagits bort.
      // I detta fall är det bara ett element vi tar bort, så det returnerar
      // en array av ett element (det med index 0).
